...
<head>
    ...
    <!-- Scripts -->
    <script src="{{ asset('resources/assets/plugins/jQuery/jquery-2.2.3.min.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ asset('resources/js/bootstrap/js/bootstrap.min.js') }}" type="text/javascript"></script>
